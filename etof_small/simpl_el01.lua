...
function segment.other_actions()
	...
	if  (ion_px_mm>=290)  then
		
		--print(ion_time_of_flight,"\t",
		--ion_px_mm ,"\t",ion_py_mm ,"\t",ion_pz_mm ,"\t",bx,"\t",by,"\t",bz,"\t",electrode3,"\t",electrode4,"\t",electrode5,
		--	"\t",ion_number,"\t",ion_color,"\n")
		FileHnd:write(ion_time_of_flight,"\t",
		ion_px_mm ,"\t",ion_py_mm ,"\t",ion_pz_mm ,"\t",e5,"\t",e6,"\t",e7,"\t",e8,"\t",e9,"\t",e10,
			"\t",ion_number,"\t",ion_color,"\n")
		ion_splat=-2
		print('i am here 2d')
	end
...
FileHnd:write("ion_time_of_flight","\t",
	...
	step1=1.0
	step2=1.0
	--for e5a=-13,20,step1 do
		
		for e6a=-13,13,step1 do
			for e7a=-10,10,step1 do
				
				for e8a=-10,10,step2 do
					for e9a=-10,10,step2 do
						for e10a=-10,10,step2 do
